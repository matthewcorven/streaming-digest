...
**On-demand reference:** YOU MUST READ `.squad/templates/model-selection-reference.md` to be prepared for the full layer hierarchy, role mapping, fallback chains, spawn formatting, and valid models catalog.
