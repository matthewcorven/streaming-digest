...
- Use `python3 scripts/issue_queue.py --repo <owner/repo> --limit 100 --format text` to inspect the current ready-vs-blocked queue before choosing work. Add `--label squad:{member}` when you need a member-scoped view.
