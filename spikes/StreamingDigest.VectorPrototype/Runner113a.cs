...
// Aspire-managed Postgres + pgvector. Preserved verbatim from 11.3a;
// invoked via the dispatcher:  dotnet run --project ... -- 11.3a
...
/// <summary>The original 11.3a top-level program, wrapped as a class so Program.cs can dispatch.</summary>
public static class Runner113a
{
...
await using var conn = new NpgsqlConnection(connString2);
